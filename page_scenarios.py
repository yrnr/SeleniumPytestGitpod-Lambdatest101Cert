"""
Making use of Page Object Model:
    - Create a separate page or class for each web page
    - Write down all locators
    - Define constants
    - Any variables you use in tests
    - Key Value pairs of form data fields and their locators
"""
